import type { ActiveModel, AuditLog, AuditSettings, AuditStats, BootstrapData, ModelPackage, Operation, PolicySettings, Profile, RedactResult, RuntimeStatus, Upstream, VersionResponse } from "./types";
...
export const coreApi = {
  ...
  saveSettings: (audit: AuditSettings) => request<{audit: AuditSettings}>("/api/v1/settings", { method: "PUT", body: JSON.stringify({ audit }) }),
