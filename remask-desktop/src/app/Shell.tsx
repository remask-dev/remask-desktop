...
export function Shell() {
  ...
  const protectionLabel = coreTransitioning
    ? t("coreStarting")
    : protectedByCore ? t("protectionOn") : connected ? t("protectionOff") : t("protectionUnavailable");
  useEffect(() => {
